/**
 * Building Context, with sample values
 */
...
const buildingContext =
{
  ...
  buildings: [
    {
      building_name: 'BCIT Kitchen 555 Seymour',
      building_details: {
        facility: {
          building_program: '',
          sst: '',
