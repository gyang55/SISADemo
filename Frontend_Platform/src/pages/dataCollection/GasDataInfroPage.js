import GasDataInfo from './subSections/General/GasData'
...
export default function GasDataInfoPage() {
    ...
    const projectLis = [curr_building.consumption_details.gas_bills]
