import ThermalInfo from './subSections/General/ThermalPlant'
...
export default function ThermalInfoPage() {
    ...
    const projectLis = [curr_building.building_details.thermal]
