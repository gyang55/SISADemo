import Equipment from "./subSections/Equipment";
...
export default function EquipmentsPage() {
    ...
    var navButtons = [newBackBtn, newAddBtn]
            ...
            <div className='grid grid-cols-6 relative'>
                <div className='col-span-5'>
                    <div className='h-700 overflow-auto'>
                        {
                            curr_building.building_details.equipments.map((equipment, i) => {
                                return (
                                    <div key={i}>
                                        <Equipment id={equipment.item_name.replaceAll(' ', '-')} name={equipment.item_name} data={equipment.item_details} />
                                    </div>)
                            })
                        }
                    </div>
