import Envelope from "./subSections/Envelope"
        ...
        <>
            ...
            <div className="flex flex-col gap-10 h-full">
                <div className="bg-white flex flex-col rounded drop-shadow-md p-5 h-fit">
                    <div>
                        {
                            curr_building.building_details.envelopes.map((envelope, i) => {
                                return (<Envelope key={i} id={envelope.item_name.replaceAll(' ', '-')} name={envelope.item_name} />)
                            })
                        }
                    </div>
