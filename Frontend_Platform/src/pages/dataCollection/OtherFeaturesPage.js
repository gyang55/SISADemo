import OtherFeaturesInfo from './subSections/General/OtherFeatures'
...
export default function OtherFeaturesInfoPage() {
    ...
    const projectLis = [curr_building.building_details.other]
